...
const initParallax = () => {
    window.addEventListener('scroll', function (e) {
        const nav = _('.navigation');
        const scrolled = window.pageYOffset;
        const elements = _('.parallax', true);
...
const toggleNavBar = () => {
    const navContainer = _('.nav-content');
...
const initNavBar = () => {
    const menuIcons = _('.menu-icon', true);
